...
export type  ModuleStatusApiFilters =
    | BaseApiFilters
    | 'name'
    | 'slug';


export type ApiFiltersType = ModulesApiFilters | ModuleTypesApiFilters | ModuleStatusApiFilters;