...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        urlModule.searchParams.append("topic", getApiRoutesWithPrefix(ApiRoutesWithoutPrefix.MODULES));
        urlModuleStatus.searchParams.append("topic", getApiRoutesWithPrefix(ApiRoutesWithoutPrefix.MODULE_STATUSES));
        urlModuleType.searchParams.append("topic", getApiRoutesWithPrefix(ApiRoutesWithoutPrefix.MODULE_TYPES));
