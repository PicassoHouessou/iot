            ...
            <div className="main main-app p-3 p-lg-4">
                <div className="d-md-flex align-items-center justify-content-between mb-4">
                    ...
                    <div className="d-flex gap-2 mt-3 mt-md-0">
                        ...
                        <Button variant="primary" className="d-flex align-items-center gap-2">
                            <i className="ri-bar-chart-2-line fs-18 lh-1"></i>Generate<span
                            className="d-none d-sm-inline"> Report</span>
                        </Button>
                    </div>
                </div>
                ...
                <Row className="g-3">
                        ...
                        <Card className="card-one">
                            <Card.Body className="overflow-hidden px-0 pb-3">
                                <div className="finance-info p-3 p-xl-4">
                                    ...
                                    <p className="w-50 fs-sm mb-2 mb-xl-4 d-none d-sm-block">Lorem ipsum dolor sit amet,
                                    ...
                                    <Row className="row-cols-auto g-3 g-xl-4 pt-2">
                                        {[
                                            ...
                                            <Col key={index}>
                                                ...
                                                <span
                                                    className="fs-sm fw-medium text-secondary d-block mb-1">{item.quarter} Quarter</span>
                                                <span
                                                    className={"fs-xs d-flex align-items-center ff-numerals text-" + item.status}>{item.percent}% <i
                                                    className={((item.status === "success") ? "ri-arrow-up-line" : "ri-arrow-down-line") + " fs-15 lh-3"}></i></span>
                                            </Col>
                                        ))}
                                    </Row>
                                ...
                                <ReactApexChart series={seriesOne} options={optionOne} type="area" height={430}
                            ...
                            <Col sm="6" xl="12">
                                <Card className="card-one">
                                    <Card.Body className="overflow-hidden">
                                        ...
                                        <p className="fs-xs text-secondary mb-0 lh-4">The gross profit you make on each
                                            dollar of sales.</p>

                                        <ReactApexChart series={seriesTwo} options={optionTwo} height={100}
                            ...
                            <Col sm="6" xl="12">
                                <Card className="card-one">
                                    <Card.Body>
                                        ...
                                        <p className="fs-xs text-secondary mb-0 lh-4">Measures your business at
                                            generating profit sales.</p>

                                        <ReactApexChart series={seriesThree} options={optionThree} height={100}
                                                        className="apex-chart-three"/>
                                    </Card.Body>
                                </Card>
                            </Col>
                    ...
                    <Col sm="6" xl>
                        <Card className="card-one">
                            <Card.Body>
                                <ReactApexChart series={seriesFour} options={optionFour} height={120} type="line"
                                                className="mb-1"/>
                                ...
                                <p className="fs-sm text-secondary mb-0">Measures your Accounts Receivable / Current
                                    Liabilities</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col sm="6" xl>
                        <Card className="card-one">
                            <Card.Body>
                                <ReactApexChart series={seriesFive} options={optionFive} height={120} type="line"
                                                className="mb-1"/>
                                ...
                                <p className="fs-sm text-secondary mb-0">Measures your Current Assets / Current
                                    Liabilities</p>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col md="7" xl="5">
                        <Card className="card-one card-wallet">
                            ...
                            <ReactApexChart series={seriesSix} options={optionSix} height={268} type="area"
                                            className="apex-chart-two"/>
                        </Card>
                    </Col>
                    <Col md="5" xl="6">
                    ...
                    <Col xl="6">
                        <Card className="card-one">
                            ...
                            <Card.Body className="pt-0">
                                <p className="fs-sm text-secondary mb-4">Profit margin is a measure of profitability. It
                                    is calculated by finding the profit as a percentage of the revenue.</p>
                    ...
                    <Col xl="8">
                        <Card className="card-one">
                            ...
                            <Card.Body className="p-4">
                                <Row className="g-4">
                                    <Col md="6">
                                        <ReactApexChart series={seriesEight} options={optionEight} height={210}
                                                        className="apex-chart-three"/>
                                    </Col>
                                    <Col md="6">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">Fixed expenses are generally
                                                    fixed in both amount and interval.</p>
                                            </div>
                                        </div>
                                        <div className="d-flex mt-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">Periodic expenses are usually
                                                    less frequent and the amount can vary.</p>
                                            </div>
                                        </div>
                                        <div className="d-flex mt-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">Change as the quantity of good
                                                    or service that produces changes.</p>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
                    ...
                    <Col xl="4">
                        <Card className="card-one">
                            ...
                            <Card.Body className="position-relative d-flex justify-content-center">
                                <ReactApexChart series={[35, 20, 20, 15]} options={optionDonut} height="auto"
                                                type="donut" className="apex-donut-two"/>
                                    ...
                                    <Col sm="6" xl="3">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">The proceeds or payment which
                                                    the company will receive from its customers.</p>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col sm="6" xl="3">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">Money owed by a business to its
                                                    suppliers shown as a liability.</p>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col sm="6" xl="3">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">Measures the ability of a
                                                    company to use its near cash or quick assets.</p>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col sm="6" xl="3">
                                        <div className="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="fs-sm text-secondary mb-0">Measures whether a firm has
                                                    enough resources to meet its short-term obligations.</p>
                                            </div>
                                        </div>
                                    </Col>
                                </Row>
                ...
                <Row className="g-3 mt-3 justify-content-center">
                    <Col md="5" xl="4">
                        <Card className="card-one">
                            ...
                            <Card.Body className="p-3">
                                <h2 className="performance-value mb-0">9.8 <small
                                    className="text-success d-flex align-items-center"><i
                                    className="ri-arrow-up-line"></i> 2.8%</small></h2>
                                ...
                                <Row className="g-4 mb-2">
                                    {[
                                        ...
                                        <Col xs="6" key={index}>
                                            ...
                                            <h3 className="card-value mb-2">{item.value} <small>{item.percent}</small>
                                            </h3>
