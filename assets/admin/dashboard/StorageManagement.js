            ...
            <div className="main main-app p-3 p-lg-4">
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div className="d-flex align-items-center gap-2 mt-3 mt-md-0">
                        <Button variant="white" className="btn-icon"><i
                            className="ri-share-line fs-18 lh-1"></i></Button>
                        <Button variant="white" className="btn-icon"><i
                            className="ri-printer-line fs-18 lh-1"></i></Button>
                ...
                <Row className="g-3">
                    <Col xs="12" sm="6" xl>
                        <Card className="card-one">
                            <Card.Body className="p-3">
                                <div className="mb-1 text-primary ti--3"><i className="ri-rocket-line fs-48 lh-1"></i>
                                </div>
                    ...
                    <Col xs="6" sm="6" xl>
                        <Card className="card-one">
                            <Card.Body className="p-3">
                                <div className="mb-1 text-primary ti--3"><i
                                    className="ri-file-text-line fs-48 lh-1"></i></div>
                    ...
                    <Col xs="6" sm="6" xl>
                        <Card className="card-one">
                            <Card.Body className="p-3">
                                <div className="mb-1 text-primary ti--3"><i className="ri-gallery-line fs-48 lh-1"></i>
                                </div>
                    ...
                    <Col xs="6" sm="6" xl>
                        <Card className="card-one">
                            <Card.Body className="p-3">
                                <div className="mb-1 text-primary ti--3"><i
                                    className="ri-folder-zip-line fs-48 lh-1"></i></div>
                    ...
                    <Col xs="6" sm="6" xl>
                        <Card className="card-one">
                            <Card.Body className="p-3">
                                <div className="mb-1 text-primary ti--3"><i className="ri-folder-2-line fs-48 lh-1"></i>
                                </div>
                            ...
                            <Card.Body className="p-3">
                                <Row className="g-3">
                                    <Col sm="4" md="3">
                                        <Row className="g-3">
                                            <Col xs="4" sm="12">
                                                <h2 className="card-value ls--1 mb-1">69.8<span
                                                    className="opacity-75">TB</span></h2>
                                                <label
                                                    className="card-label fw-medium text-secondary fs-sm fs-sm-normal">Total
                                                    Storage</label>
                                            </Col>
                                            <Col xs="4" sm="12">
                                                <h2 className="card-value ls--1 mb-1">836.5<span
                                                    className="opacity-75">K</span></h2>
                                                <label
                                                    className="card-label fw-medium text-secondary fs-sm fs-sm-normal">Object
                                                    Count</label>
                                            </Col>
                                            <Col xs="4" sm="12">
                                                <h2 className="card-value ls--1 mb-1">88.1<span
                                                    className="opacity-75">MB</span></h2>
                                                <label
                                                    className="card-label fw-medium text-secondary fs-sm fs-sm-normal">Avg.
                                                    Object Size</label>
                                            </Col>
                                        </Row>
                                    </Col>
                    ...
                    <Col md="6" xl="4">
                        <Card className="card-one card-daily-trends">
                            <Card.Body className="p-3">
                                ...
                                <p className="text-secondary">CPU Power - <span
                                    className="ff-numerals">11/20/2023</span></p>
                                <h1 className="card-value">2836 <span>KHz</span></h1>
                            </Card.Body>
                            <ReactApexChart series={seriesTwo} options={optionTwo} type="area" height={'100%'}
                        ...
                        <Card className="card-one">
                            ...
                            <Card.Body className="p-3">
                                <label className="d-block fs-sm mb-2">
                                    <span className="ff-numerals">25.93</span> GB available of <span
                                    className="ff-numerals">127.18</span> GB
                                </label>
                                ...
                                {[
                                    ...
                                    <div className="storage-item" key={index}>
                                        ...
                                        <div className="flex-fill">
                                            ...
                                            <div
                                                className="d-flex justify-content-between ff-numerals fs-xs text-secondary">
                    ...
                    <Col md="5" lg="6" xl="4">
                        <Card className="card-one card-article">
                            <Card.Body>
                                ...
                                <h4 className="card-title mb-3">Overhaul Cloud-based Storage Analytics and Monitoring
                                    Suite</h4>
                                <p className="text-secondary mb-4">Nam libero tempore, cum soluta nobis est eligendi
                                    optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis
                                    voluptas assumenda est similique sunt in culpa qui officia deserunt mollitia
                                    animi.</p>
