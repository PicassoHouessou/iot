import {ApiRoutesWithoutPrefix, DATE_FORMAT} from '@Admin/constants';
...
export const formatDate = (date: ConfigType, locale: Locale = defaultLocale, withHour = true) => {
    ...
    const formatedDate = dayjs(date).locale(locale).format(
        withHour
