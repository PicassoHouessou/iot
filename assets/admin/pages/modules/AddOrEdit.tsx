...
export default function AddOrEdit() {
    ...
    const {data: moduleTypeOptions} = useModuleTypesQuery({pagination: false});
    ...
    React.useEffect(() => {
        if (Array.isArray(moduleTypeOptions) && moduleTypeOptions.length) {
            const find = moduleTypeOptions.find((item: ModuleType) => item.id == data?.type?.id);
    ...
    const handleSubmit = async (e: any) => {
        ...
        const data = {
            ...rest,
            type: generateIRI(ApiRoutesWithoutPrefix.MODULE_TYPES, selectedModuleType.id) as string,
        };
                ...
                <div className="d-md-flex align-items-center justify-content-between mb-4">
                    <div>
                        <ol className="breadcrumb fs-sm mb-1">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Ajout</li>
                        </ol>
                            ...
                            <Card.Body>
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <Select name="type" options={moduleTypeOptions}
                                                onChange={(e, action) =>
