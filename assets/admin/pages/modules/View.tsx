...
export default function View() {
    ...
    const {data: histories, isLoading} = useModulesJsonLdQuery(query, {skip: id ? false : true});
    ...
    useEffect(() => {
        if (histories) {
            const newData = histories["hydra:member" as unknown as keyof typeof histories];
            setData(newData);
            if (histories['hydra:view' as unknown as keyof typeof histories] && histories['hydra:view' as unknown as keyof typeof histories]['hydra:next']) {
                setCanLoadMore(true);
            } else {
    ...
    const onLoadMore = useCallback(() => {
        if (canLoadMore) {
            setQuery((prevState: any) => ({...prevState, page: prevState.page ? prevState.page + 1 : 2}));
        }
        //setCanLoadMore(false)
    ...
    const renderItem = (item: any, index: number) => {
        ...
        return (<>
            ...
            <li className="activity-item search"
                ref={list?.length > 1 && index === list?.length - 1 ? loadMoreRef : null}>
                <p className="d-sm-flex align-items-center mb-0">
                    <Link to="" className="avatar avatar-xs me-2 d-none d-sm-inline"><img
                        src={img1}
                        alt=""/></Link>
                    <span
                        className="fs-sm"><strong>You</strong> searched using a keyword <strong>&quot;restaurant&quot;</strong></span>
        ...
        <React.Fragment>
            ...
            <div className="main main-app p-3 p-lg-4">
                <div className="d-md-flex align-items-center justify-content-between mb-4">
                    <div>
                        <ol className="breadcrumb fs-sm mb-1">
                            <li className="breadcrumb-item"><Link to={AdminPages.MODULES}>Modules</Link></li>
                ...
                <div className="main p-4 p-lg-5">
                    <Row className="g-5">
                        <Col xl="9">
                            <h2 className="main-title mb-3">Type: {module?.type?.name}</h2>
                            ...
                            <ul className="activity-group mb-5">
                                ...
                                <li className="activity-item search">
                                    <p className="d-sm-flex align-items-center mb-0">
                                        <Link to="" className="avatar avatar-xs me-2 d-none d-sm-inline"><img src={img1}
                                                                                                              alt=""/></Link>
                                        <span
                                            className="fs-sm"><strong>You</strong> searched using a keyword <strong>&quot;restaurant&quot;</strong></span>
                                        <span className="fs-xs text-secondary ms-auto">10:00am</span>
                                ...
                                <li className="activity-item search">
                                    <p className="d-sm-flex align-items-center mb-0">
                                        <Link to="" className="avatar avatar-xs me-2 d-none d-sm-inline"><img src={img1}
                                                                                                              alt=""/></Link>
                                        <span
                                            className="fs-sm"><strong>You</strong> searched using a keyword <strong>&quots;oftware engineer&quot;</strong></span>
                                ...
                                <li className="activity-item search">
                                    <p className="d-sm-flex align-items-center mb-0">
                                        <Link to="" className="avatar avatar-xs me-2 d-none d-sm-inline"><img src={img1}
                                                                                                              alt=""/></Link>
                                        <span
                                            className="fs-sm"><strong>You</strong> searched using a keyword <strong>&quot;ui developer&quot;</strong></span>
