                ...
                <div className="d-md-flex align-items-center justify-content-between mb-4">
                    <div>
                        <ol className="breadcrumb fs-sm mb-1">
                            <li className="breadcrumb-item"><Link to={AdminPages.MODULE_TYPES}>Modules</Link></li>
                ...
                <div className="main main-docs">
                    <Container>
                        <Card>
                            <Card.Body>
                                <div className="mb-3">
                                    <Form.Label htmlFor="exampleFormControlInput1">Nom</Form.Label>
                                    <Form.Control type="email" id="exampleFormControlInput1"
                                ...
                                <div className="mb-3">
                                    <Form.Label htmlFor="exampleFormControlTextarea1">Type</Form.Label>
                                    <Select options={selectOptions} isSearchable={true}/>
                                </div>
                                <div><Button variant="primary">Enregistrer</Button></div>
                            </Card.Body>
                        </Card>
