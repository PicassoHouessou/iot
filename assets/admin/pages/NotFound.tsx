    ...
    return (
        <div className="page-error">
            <div className="header">
                <Container>
                    <Link to="/" className="header-logo">IoTAdmin</Link>
                ...
                <Container>
                    <Row className="gx-5">
                        <Col lg="5" className="d-flex flex-column align-items-center">
                            ...
                            <p className="error-text">Oopps. The page you were looking for doesn't exist. You may have
                                mistyped the address or the page may have moved.</p>
                            <Link to={AdminPages.DASHBOARD} className="btn btn-primary btn-error">Back to
                                Dashboard</Link>
                        </Col>
