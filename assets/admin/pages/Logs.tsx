                    ...
                    <Table className="table table-files" responsive>
                        ...
                        {[
                            ...
                            <tr key={index}>
                                <td>
                                    <div className="media">
                                        <h6 className="file-name"><Link to="">{file.name}</Link></h6>
                                    </div>
                                </td>
                                <td>{file.date}</td>
                                <td>{file.date}</td>
                                ...
                                <td>
                                    <Dropdown align="end" className="dropdown-file">
                                        ...
                                        <Dropdown.Menu>
                                            <Dropdown.Item className="details"><Link to={"/modules/see"}><i
                                                className="ri-information-line"
                                            ></i> Voir Détails</Link></Dropdown.Item>
                                            <Dropdown.Item href="#" className="share"><i
                                                className="ri-edit-line"></i> Modifier</Dropdown.Item>
                                            <Dropdown.Item href="#" className="delete"><i
                                                className="ri-delete-bin-line"></i> Delete</Dropdown.Item>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                </td>
                            </tr>
