...
export default function VerifyAccount() {
    ...
    const handleResend = async () => {
        try {
            ...
            setMessage({success: t("Veuillez vérifier votre boîte de messagerie"), error: ""});
        } catch (err) {
                ...
                <Container>
                    <Card className="card-auth">
                        <Card.Body className="text-center">
                            ...
                            <Card.Text
                                className="mb-5">{t("Veuillez vérifier votre courrier électronique et cliquez sur le bouton ou le lien de vérification pour vérifier votre compte")}
                            </Card.Text>
                            ...
                            <Row className="g-2 g-sm-3">
                                ...
                                <Col sm>
                                    <a
                                        href={`mailto:${AUTHOR.EMAIL}`}><Button
                                        variant="secondary">{t("Contacter Support")}</Button></a>
                                </Col>
                            </Row>
                        </Card.Body>
                    </Card>
