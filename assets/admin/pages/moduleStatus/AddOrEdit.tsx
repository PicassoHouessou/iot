...
import {useAddModuleMutation, useModuleStatusQuery, useUpdateModuleStatusMutation} from "@Admin/services/modulesApi";
...
export default function AddOrEdit() {
    ...
    const {data,} = useModuleStatusQuery(idParam!, {skip: idParam ? false : true});
