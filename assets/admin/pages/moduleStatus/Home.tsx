...
export default function Home() {
    ...
    const {isLoading: loading, error, data: dataApis} = useModuleStatusesJsonLdQuery(query);
        ...
        },
        {
            ...
            render: (text, record) => {
                const items: MenuProps['items'] = [
                    {
                        label: <Link className="details" to={`${AdminPages.MODULE_STATUSES_EDIT}/${record.id}`}><i
                ...
                <div className="d-md-flex align-items-center justify-content-between mb-4">
                    <div>
                        <ol className="breadcrumb fs-sm mb-1">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Etats de module</li>
                        </ol>
