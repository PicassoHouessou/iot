            ...
            <div className="sidebar">
                ...
                <div className="sidebar-footer">
                    <div className="sidebar-footer-top">
                        ...
                        <Link onClick={this.toggleFooterMenu} to="" className="dropdown-link"><i
        ...
        const menu = m.map((m, key) => {
            ...
            return (
                <li key={key} className="nav-item">
                    {(!sm) ? (
                        <NavLink to={m.link} className="nav-link"><i className={m.icon}></i>
                            <span>{m.label}</span></NavLink>
                    ) : (
                        <div onClick={this.toggleSubMenu} className="nav-link has-sub"><i className={m.icon}></i>
