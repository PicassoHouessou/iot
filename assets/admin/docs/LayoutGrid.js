...
export default function LayoutGrid() {
        ...
        <React.Fragment>
            ...
            <div className="main main-docs">
                <Container>
                    ...
                    <p className="main-title-text">Use Bootstrap&apos;s powerful mobile-first flexbox grid to build
                        layouts
                    ...
                    <p>Bootstrap&apos;s grid system uses a series of containers, rows, and columns to layout and align
                        content. It&apos;s built with flexbox and is fully responsive. Below is an example and an
                        in-depth
                        look at how the grid comes together.</p>
  ...
  <Col><span>3 of 3 Column</span></Col>
                    ...
                    <p>Auto-layout for flexbox grid columns also means you can set the width of one column and have the
                        sibling columns automatically resize around it.</p>
  ...
  <Col><span>3 of 3 Column</span></Col>
                    ...
                    <p>Using a single set of classes, you can create a basic grid system that starts out stacked and
                        becomes horizontal at the small breakpoint.</p>
  ...
  <Col sm="5"><span>2 of 2 Column</span></Col>
                    ...
                    <p>Use these row columns classes to quickly create basic grid layouts or to control your card
                        layouts.</p>
